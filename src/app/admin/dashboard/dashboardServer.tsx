...
export async function assignCourse(user_id: string, course_id: string) {
    ...
    await axios.post(req('api/user_courses'), {
        user_id: user_id,
        course_id: course_id,
...
export async function assignAssignments(user_id: string, assignment_id: string) {
    await axios.post(req('api/user_assignments'), {
        user_id: user_id,
...
export async function deleteCourse(user_id: string, course_id: string) {
    await axios.delete(req('api/user_courses/' + user_id), {
        params: { id: user_id, },
...
export async function deleteAssignment(user_id: string, assignment_id: string) {
    await axios.delete(req('api/user_assignments/' + user_id), {
        params: { id: user_id, },
