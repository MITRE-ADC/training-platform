...
const TagInput = React.forwardRef<HTMLInputElement, TagInputProps>(
  ...
  (props, ref) => {
    ...
    return (
      <div
        className={`w-content flex ${!inlineTags && tags.length > 0 ? "gap-3" : ""} ${
          inputFieldPosition === "bottom"
            ? "flex-col"
          ...
          <div className="w-full">
            <Autocomplete
              ...
              classStyleProps={{
                ...
                span: styleClasses?.autoComplete?.span,
              ...
              {!usePopoverForTags ? (
                !inlineTags ? (
                  <Input
                    ...
                    {...inputProps}
                    className={cn(
                      "h-5 w-fit flex-1 bg-transparent",
                      styleClasses?.input
                    )}
                    autoComplete={enableAutocomplete ? "on" : "off"}
                    list={
            ...
            {!usePopoverForTags ? (
              ...
              >
                <Input
                  ...
                  className={cn("w-full border-0", styleClasses?.input)}
                />
              </TagPopover>
            )}
          </div>
